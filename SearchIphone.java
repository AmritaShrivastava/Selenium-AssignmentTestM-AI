...
public class SearchIphone {
    ...
    void launchAmazonWebsite() throws Exception {
        ...
        ltOptions.setCapability("name", "Search iPhone Test");
	...
	void addToCart()
	{
		driver.findElement(By.id("a-autoid-1-announce")).click(); //here 1st listed iphone is showing
	}
    ...
    void printIphonePrice() {
        ...
        System.out.println("Selected iPhone Price is:" + iphonePrice);
    }
